...
public class EditGenero {
    ...
    public void initialize (Genero genero) throws SQLException {
        inputNombre.setText(genero.getNombre());
        inputDescripcion.setText(genero.getDescripcion());
    }
